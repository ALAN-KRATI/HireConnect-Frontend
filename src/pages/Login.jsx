...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="bg-white rounded-2xl shadow-xl overflow-visible max-w-4xl w-full flex">
        {/* Left Side - Form */}
        <div className="w-full md:w-1/2 p-8 lg:p-12">
          <Link to="/" className="text-2xl font-bold text-blue-600">HireConnect</Link>
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-50 to-indigo-100 items-center justify-center p-12">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Login with GitHub</h3>
            <p className="text-gray-600 mb-6">We use GitHub for a seamless and secure sign-in experience.</p>
            <button
              onClick={handleGitHubLogin}
              className="inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white font-semibold rounded-lg hover:bg-gray-800 transition-colors"
            >
